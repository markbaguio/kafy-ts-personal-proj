...
export default function NotFoundPage() {
  return (
    <div className='bg-[url("/img/rizky-subagja-1k7TnX5GAww-unsplash.jpg")] h-screen bg-cover flex items-center justify-center'>
      <div className="border border-off-white w-[850px] h-[600px] px-8 gap-8 bg-off-white/10 backdrop-blur-md bg-linear-to-br from-off-white/10 to-[#666666]/10  rounded-[50px] flex items-center justify-center flex-col">
